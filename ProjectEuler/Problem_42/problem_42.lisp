...
(with-open-file (stream "/home/michael/Scripts/ProjectEuler/Problem_42/words.txt")
    (do ((*r* (read-line stream nil)
        ...
        (setf *stringggg* *r*)))
;(print *stringggg*)
(defparameter *strin* "(defparameter num 0) (setf num(+ ")
(defparameter num 0)
...
(if (= num 231) (print "true") (if (= num 253) (print "true")))))))))))))))))))))))
	  ...
	  "(if (= num 1) (print t) (if (= num 3) (print t) (if (= num 6) (print t) (if (= num 10) (print t) (if (= num 15) (print t) 
(if (= num 21) (print t) (if (= num 28) (print t) (if (= num 36) (print t) (if (= num 45) (print t) (if (= num 55) (print t)
(if (= num 66) (print t) (if (= num 78) (print t) (if (= num 91) (print t) (if (= num 105) (print t) (if (= num 120) (print t)
(if (= num 136) (print t) (if (= num 153) (print t) (if (= num 171) (print t) (if (= num 190) (print t) (if (= num 210) (print t)
(if (= num 231) (print t) (if (= num 253) (print t)))))))))))))))))))))))"
	  "(setf num(" "+ " )))
